...
vicious.register(volicon, vicious.widgets.volume, "$2", 5 , "Master" )
vicious.register(volwidget, vicious.widgets.volume, "$1%", 5, "Master")
vicious.unregister(volicon, true)
vicious.unregister(volwidget,true)
volwidget:buttons(awful.util.table.join(
    awful.button({ }, 3, function () awful.util.spawn("pavucontrol") end),
    --awful.button({ }, 1, function () awful.util.spawn("amixer -q sset Master toggle") end),
    awful.button({ }, 4, function () awful.util.spawn("amixer -q sset Master 1%+", false)
                                     sleep(0.2)
                                     vicious.force({volwidget}) end),
    awful.button({ }, 5, function () awful.util.spawn("amixer -q sset Master 1%-", false)
                                     sleep(0.2)
                                     vicious.force({volwidget}) end)
))
volicon:buttons(awful.util.table.join(
    awful.button({ }, 1, function () awful.util.spawn("amixer -q sset Master toggle")
                                     sleep(0.2)
                                     vicious.force({volicon}) end)
))
...
hdwidget = awful.widget.progressbar()
-- Progressbar properties
hdwidget:set_width(6)
hdwidget:set_height(8)
hdwidget:set_vertical(true)
hdwidget:set_background_color("#494B4F")
hdwidget:set_border_color(nil)
hdwidget:set_color({ type = "linear", from = { 0, 0 }, to = { 10,0 }, stops = { {0, "#AECF96"}, {0.5, "#88A175"},
                    {1, "#FF5656"}}})
-- Register widget
...
perceptive.register(weatherwidget)
...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ 'Term', 'VNC', 'WEB', 'VIM', 5, 6, 7, 'XMPP', 9 }, s, layouts[1])
end
-- }}}
